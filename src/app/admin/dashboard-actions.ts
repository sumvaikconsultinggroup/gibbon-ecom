...
import { startOfDay, endOfDay, subDays, startOfMonth, endOfMonth, startOfYear, format, eachDayOfInterval, eachWeekOfInterval, eachMonthOfInterval, parseISO } from 'date-fns'
...
export async function fetchDashboardData(
  ...
  try {
    ...
    orders.forEach((o: any) => {
      const method = o.paymentMethod || o.payment?.method || o.paymentDetails?.method || 'unknown'
    ...
    return {
      ...
      data: {
        ...
        recentOrders: recentOrders.map((o: any) => ({
          ...
          customer: o.customer?.name || o.customer?.firstName || o.shippingAddress?.name || o.shippingAddress?.firstName || 'Guest',
          email: o.customer?.email || o.email || '',
          total: o.totalAmount || o.total || 0,
          status: o.status || 'pending',
          paymentStatus: o.paymentStatus || o.paymentDetails?.status || 'pending',
