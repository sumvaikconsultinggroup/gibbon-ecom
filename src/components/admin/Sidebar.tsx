...
const sidebarItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Video Reels', href: '/admin/videos', icon: Video, permission: 'settings.view', badge: 'New' },
      ...
      { name: 'Reviews', href: '/admin/reviews', icon: MessageSquare, permission: 'settings.view', badge: 'New' },
      { name: 'Recommendations', href: '/admin/recommendations', icon: Sparkles, permission: 'settings.view', badge: 'New' },
    ],
  },
  {
    name: 'Catalog',
    ...
    children: [
      ...
      { name: 'Bundle Offers', href: '/admin/bundles', icon: Tag, permission: 'products.view', badge: 'New' },
    ],
  },
  {
    name: 'Inventory',
